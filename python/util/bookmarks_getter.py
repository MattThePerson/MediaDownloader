...
class BookmarksGetter:
    ...
    @classmethod
    def get_bookmarks(cls, browser, foldername=None, domain=None, sortby=None, reverse=False) -> list[Any]:
        ...
        bookmarks_path = bookmarks_path.replace(r'%localappdata%', '/mnt/c/Users/stirl/AppData/Local') # WSL
        ...
        if browser.lower() in 'chrome chromium bravesoftware edge':
            ...
            return []
        bookmarks = [ b for b in bookmarks if (foldername==None or foldername.lower() in b.get('location').lower().split('/')) ] # filter by foldername
